<?php
/**
 * JCUBSA_theme functions and definitions
 *
...
function jcubsa_theme_setup() {
	/*
		...
		* If you're building a theme based on JCUBSA_theme, use a find and replace
		* to change 'jcubsa_theme' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'jcubsa_theme' ),
		)
	);
