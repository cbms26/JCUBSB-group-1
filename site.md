...
**Step 2:** Enter a title and content for the page using the Block Editor.
**Step 3:** Configure page attributes such as parent page, template, and order if necessary.
**Step 4:** Preview the page to ensure it looks correct.
**Step 5:** Click `Publish` to make the page live.

### Posts
**Step 1:** Navigate to `Posts > Add New`.
**Step 2:** Enter a title and content for the post.
**Step 3:** Assign the post to one or more categories to help organize the content.
**Step 4:**. Add tags if necessary to improve searchability.
**Step 5:** Set a featured image to represent the post visually.
**Step 6:** Preview the post and click `Publish` to make it live.
...
## Managing Plugins
### Installed Plugins
**Step 1:**. **WPForms** insert contact form,feedback form,join us form.
**Step 2:** **Popup maker** disply join now form and feedback form.
**Step 3:** **The Events calendar** Manage and display events and event calendars

### Adding New Plugins
**Step 1:** Navigate to `Plugins > Add New`.
**Step 2:** Search for the desired plugin using the search bar.
**Step 3:** Click `Install Now` next to the plugin you wish to add.
...
2. **Limit Login Attempts:** Configure the site to limit login attempts to prevent brute force attacks.
